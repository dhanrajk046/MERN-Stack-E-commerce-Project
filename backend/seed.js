...
const products = [
  ...
  },
  {
    ...
    category: 'Electronics',
    stock: 35,
    imageUrl: 'https://images.unsplash.com/photo-1609592424824-4fbd6a1225ce?auto=format&fit=crop&w=800&q=80',
    rating: 4.3,
    numReviews: 19,
  },
];
...
const seed = async () => {
  try {
    ...
    console.log(`Seed complete: ${products.length} sample products are available.`);
    console.log('Demo admin: admin@shopnest.test / Admin@12345');
